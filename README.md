...
- **Readability styling**: the connector words "vor", "nach", and "Uhr" can optionally be italicized (in addition to the default bold), to make them easier to tell apart from the numbers.
